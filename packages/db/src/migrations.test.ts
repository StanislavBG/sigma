...
// the ones before it (e.g. 0005's ADD COLUMNs must not duplicate columns already in 0000).
...
describe('served migrations', () => {
  ...
  it('builds the served schema from the migration chain', () => {
    ...
    try {
      ...
      // 0005 adds the health-index foundation columns (contract quality spec §7.1) — additive
