        ...
        <div className="analyze-landing">
          ...
          <div className="az-cards">
            ...
            <AnalyzeCard
              ...
              titleEm="времето"
              desc={
                'Как се движат разходите по месеци и години — сезонните пикове — само по реални данни. Обзорът „По CPV код" показва типичните цени по категории и договорите, необичайно скъпи спрямо сходни поръчки.'
              }
              cta="Виж тренда"
              stats={[
                {
