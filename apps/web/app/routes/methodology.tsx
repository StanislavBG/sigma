          ...
          <div>
            ...
            <section className="section" aria-labelledby="views">
              ...
              <p className="section-hint">
                ...
                при сключване; договорите с непотвърдена достоверност на стойността се изключват от
                сумите (<a href="#source">раздел 2</a>). Числата са <strong>ориентир</strong>, не
                заключение.
              </p>
              ...
              <p>
                Индекс на аналитичните изгледи. Всяка карта показва по два показателя от съответното
                табло и води към него; самата страница не смята нищо ново. Оттук са достъпни
                здравето на договора, раздуването, потоците, тренда, картата и конкуренцията;
                сравнението на две същности (<Link to="/compare">Сравнение</Link>) също е част от
                изгледите.
              </p>
              ...
              <p>
                ...
                месец", отбелязан като „частично". Сравнението спрямо предходната година се прави
                само между две съседни години и се пропуска за непълната година. Графиката показва{' '}
                <strong>само реални (сключени) стойности</strong> — без прогноза.
              </p>
              <p>
                Панелът „Цени по CPV код" взема групите с най-много договори (петцифрен клас на CPV)
                и за всяка показва типичната цена (медианата) и диапазона p10–p90 върху действителни
                стойности. Етикетът <span className="mono">„спрямо типичното"</span> сравнява
                стойността на договора с медианата за неговия CPV клас: над ≈1,3× е „над типичното",
                под ≈0,75× — „под типичното". Един договор се отбелязва като отклонение, когато е
                висок спрямо кохортата си (логаритмично z ≥ 3 в група от поне 30 съпоставими
                договора в рамките на ±1 година).
              </p>
              ...
              <p>
                ...
                разделен на сбора на подписаните стойности, а не средно на процентите. „Типичен
                растеж" е медианата; средното се показва отделно като изкривено нагоре от малкото
                огромни случаи.
              </p>
              ...
              <p>
                ...
                свързаните с него линии. Под графиката пълният списък с всички преки контрагенти на
                центъра се показва по страници.
              </p>

              <h3 id="views-compare">
                <Link to="/compare">Сравнение</Link> — две същности една до друга
              </h3>
              <p>
                Две институции <em>или</em> две компании (никога смесени), избрани по адрес и
                показани една до друга по общи показатели: обща стойност, брой договори, различни
                контрагенти, средна стойност на договор, средно оферти на търг и дял с финансиране
                от ЕС. Само там, където сравнението е смислено (конкуренция), по-добрата страна е
                удебелена; останалите показатели са неутрални. Класацията отчита средни само за
                същности с поне 5 договора.
              </p>
              ...
              <p>
                ...
                стойности в евро; договорите с непотвърдена стойност се броят отделно като
                „непотвърдена стойност", а не се сумират. Филтрите (година, сектор, вид процедура,
                стойностен клас, финансиране от ЕС, само с една оферта, CPV клас, търсене) се
                записват в адреса и всяка комбинация има постоянен линк.
              </p>
            </section>

            <section className="section" aria-labelledby="quality">
              <h2 id="quality">8. Индексът за здраве на договора</h2>
              <p>
                Таблото <Link to="/quality">Качество на договора</Link> дава на всеки договор
                съставен индекс 0–100 (по-високо = по-здрав процес) от пет измерения. Това е{' '}
                <strong>сигнал за преглед, не присъда</strong>: ниската оценка говори за слабо
              ...
              <p>
                ...
                получава етикет „недостатъчно данни", <strong>никога нула</strong>, и не влиза в
                нито една средна. Всяка оценка е проследима до конкретните договори.
              </p>

              <h3 id="quality-pillars">Петте измерения и теглата им</h3>
              <dl className="facts">
                <div className="row">
                  <dt>A · Контестабилност — 30%</dt>
                  <dd>
                ...
                <div className="row">
                  <dt>B · Откритост на процедурата — 15%</dt>
                  <dd>
                ...
                <div className="row">
                  <dt>C · Интегритет на стойността — 25%</dt>
                  <dd>
                ...
                <div className="row">
                  <dt>E · Прозрачност на данните — 10%</dt>
                  <dd>
              ...
              <h3 id="quality-formula">Как се сглобява оценката</h3>
              <p>
                Във всяко измерение: <strong>претеглена средна</strong> на наличните показатели.
                Между измеренията:{' '}
                <strong>0,6 × претеглената средна + 0,4 × най-слабото измерение</strong> — така едно
              ...
              <p>
                ...
                оставя договора <strong>неоценен</strong>, извън всички средни.
              </p>

              <h3 id="quality-coverage">Покритие, увереност и обобщения</h3>
              <p>
                До всяка оценка се докладва покритие (дял налични показатели), но то{' '}
                <strong>никога не влиза в аритметиката</strong>. Праговете: ≥ 0,80 „високо",
              ...
              <p>
                Средните по институция и доставчик са <strong>претеглени по стойност</strong>, но с
            ...
            <section className="section" aria-labelledby="identity">
              <h2 id="identity">9. Имена, ЕИК, УНП</h2>
              <p>
            ...
            <section className="section" aria-labelledby="gaps">
              <h2 id="gaps">10. Известни празнини в полетата</h2>
              <p className="section-hint">
            ...
            <section className="section" aria-labelledby="export">
              <h2 id="export">11. Сваляне и достъп до данните</h2>
              <p>
            ...
            <section className="section" aria-labelledby="contact">
              <h2 id="contact">12. Поправки и обратна връзка</h2>
              <p>
