    ...
    <section className="pa-panel pa-method" aria-labelledby="pa-method-h">
      ...
      <div className="pa-method-body">
        <div className="pa-method-block">
          ...
          <p>
            <strong>Разгледана алтернатива:</strong> вместо плъзгащ прозорец можехме да делим всяка
            стойност на медианата за нейната CPV група <em>и</em> година (ценови индекс по
            CPV×година) и да класираме така изгладената стойност спрямо целия период. Това би запазило
            повече договори, но въвежда скокове на границите на годините и нестабилни медиани за редки
            CPV-години. Избрахме ±1-годишния прозорец — по-плавен и по-лесен за обяснение.
          </p>
        </div>
