 ...
 * variant (CWE-349) — same contract as contractListFilters' single ?cpv below. The raw-input bound
 * is loose (MAX_CPV_RAW_VALUES) and the precise cap is applied only after validation, so leading
 * invalid params can't truncate away valid codes.
 */
